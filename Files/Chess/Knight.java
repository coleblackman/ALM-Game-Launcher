...
public class Knight extends Piece {
	public static boolean isValidMoveBlack(int fy, int fx, int sx, int sy) {
		...
		if (!(((fy + 1 == sx) && (fx + 2 == sy || fx - 2 == sy)) || ((fy + 2 == sx) && (fx + 1 == sy || fx - 1 == sy))
	...
	public static boolean isValidMoveWhite(int fx, int fy, int sx, int sy) {
		// System.out.println("WOO"+fx+fy+sx+sy + "\u2656" +
		// GUIPanel.b1[fy][fx].getText());
		for (int i = 0; i < 6; i++) {
		...
		if (GUIPanel.b1[sx][sy].getText() != "" && GUIPanel.b1[sx][sy].getText() != "\u2658"
				&& GUIPanel.b1[sx][sy].getText() != "\u2657" && GUIPanel.b1[sx][sy].getText() != "\u2654"
				&& GUIPanel.b1[sx][sy].getText() != "\u265A" && GUIPanel.b1[sx][sy].getText() != "\u2655"
				&& GUIPanel.b1[sx][sy].getText() != "\u265B") {
			// System.out.println("Hello");
			return false;
		}

		System.out.println("WOO" + fx + fy + sx + sy + "\u2656" + GUIPanel.b1[fy][fx].getText());
		if (sx != fx - 1 && sx != fx + 1 && sx != fx + 2 && sx != fx - 2 && sy != fy - 2 && sy != fy + 2 && sy != fy - 1
				&& sy != fy + 1) {
